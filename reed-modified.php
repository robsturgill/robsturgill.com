...
<body class="hidden">
  <main>
    <div class="cd-index cd-main-content">
      ...
      <!-- Page Content -->
      <div id="page-content" class="light-content" data-bgcolor="#5177bb" data-textcolor="#fff">
        ...
        <div id="main">
          ...
          <div id="hero-image" class="hidden" style="background-image:url(/assets/img/projects/reed-modified/reed-modified-hoodie.jpg)">
          ...
          <div id="main-content">
            ...
            <div class="vc_row has-animation row_padding_top row_padding_bottom animate-in" data-delay="10">
              <div class="container">
                <img class="img-center" src="/assets/img/projects/reed-modified/reed-modified-variations.jpg" alt="Reed Modified Logo">
              </div>
            </div>
            <!--/Row -->
